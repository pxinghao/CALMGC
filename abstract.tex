...
Unfortunately, Edelweiss depended on non-monotone negations for opportunities for garbage collection and also used non-monotone deletions to reclaim storage, which appears to diverge from the original motivation of immutability, namely, to write monotone and thus coordination-free programs.
